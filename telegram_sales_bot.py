...
# ============================================================
# TWIN PACK TELEGRAM %100 OTOMATIK KRIPTO SATIS BOTU
# ============================================================

BOT_TOKEN = "8608754130:AAHG2twApEYgiLWP3tBrqG6NQz27dHZDZEw"
...
# ============================================================
# TRON BLOCKCHAIN OTOMATIK ODEME TESPIT MOTORU (20s DONGU)
# ============================================================
                    ...
                    for tx in data["data"]:
                        ...
                        if to_addr == USDT_TRC20_ADDRESS and tx_hash not in processed_tx_hashes:
                            ...
                            if usdt_received in pending_orders:
                                ...
                                # 1. MUSTERIYE OTOMATIK KOD TESLIM ET
                                success_msg = (
                                ...
                                send_telegram_message(target_chat_id, success_msg)
                                
                                # 2. YONETICIYE OTOMATIK SATIS BILDIRIMI GONDER
                                admin_msg = (
                    ...
                    for update in data["result"]:
                        ...
                        if "message" in update:
                            ...
                            if text == "/start" or text == "/satinal":
                                ...
                                send_telegram_message(chat_id, welcome_msg, main_menu())
                            ...
                            if cb_data.startswith("buy_"):
                                ...
                                if pkg_key in PACKAGES:
                                    ...
                                    send_telegram_message(chat_id, pay_msg, confirm_kb)

                            elif cb_data == "back_to_menu":
                                send_telegram_message(chat_id, "<b>Ana Menu:</b>", main_menu())
